...
<div class="content">
    <div class="container">
        <div class="row pt-5">
            <div class="col-md-5 pt-4 ml-auto">
                ...
                <div class="info-area info-horizontal">
                    ...
                    <div class="description">
                        ...
                        <p class="description">
                            {{ __("We've developed the website with HTML5 and CSS3.") }}
                        </p>
                    </div>
                </div>
                <div class="info-area info-horizontal">
                    ...
                    <div class="description">
                        ...
                        <p class="description">
                            {{ __('There is also a Fully Customizable Admin Dashboard.') }}
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 pt-4 mr-auto">
